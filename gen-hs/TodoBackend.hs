...
from_CreateTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v11 -> P.Just (1, ("title",T.TString $ E.encodeUtf8 _v11))) $ createTodo_args_title record
  ]
...
to_CreateTodo_args (T.TStruct fields) = CreateTodo_args{
  createTodo_args_title = P.maybe (createTodo_args_title default_CreateTodo_args) (\(_,_val13) -> (case _val13 of {T.TString _val14 -> E.decodeUtf8 _val14; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CreateTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v17 -> P.Just (0, ("success",from_Todo _v17))) $ createTodo_result_success record
  ]
...
to_CreateTodo_result (T.TStruct fields) = CreateTodo_result{
  createTodo_result_success = P.maybe (createTodo_result_success default_CreateTodo_result) (\(_,_val19) -> (case _val19 of {T.TStruct _val20 -> (to_Todo (T.TStruct _val20)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_GetTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v23 -> P.Just (1, ("id",T.TI32 _v23))) $ getTodo_args_id record
  ]
...
to_GetTodo_args (T.TStruct fields) = GetTodo_args{
  getTodo_args_id = P.maybe (getTodo_args_id default_GetTodo_args) (\(_,_val25) -> (case _val25 of {T.TI32 _val26 -> _val26; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v29 -> P.Just (0, ("success",from_Todo _v29))) $ getTodo_result_success record
  ]
...
to_GetTodo_result (T.TStruct fields) = GetTodo_result{
  getTodo_result_success = P.maybe (getTodo_result_success default_GetTodo_result) (\(_,_val31) -> (case _val31 of {T.TStruct _val32 -> (to_Todo (T.TStruct _val32)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_UpdateTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v35 -> P.Just (1, ("todo",from_Todo _v35))) $ updateTodo_args_todo record
  ]
...
to_UpdateTodo_args (T.TStruct fields) = UpdateTodo_args{
  updateTodo_args_todo = P.maybe (updateTodo_args_todo default_UpdateTodo_args) (\(_,_val37) -> (case _val37 of {T.TStruct _val38 -> (to_Todo (T.TStruct _val38)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v41 -> P.Just (0, ("success",from_Todo _v41))) $ updateTodo_result_success record
  ]
...
to_UpdateTodo_result (T.TStruct fields) = UpdateTodo_result{
  updateTodo_result_success = P.maybe (updateTodo_result_success default_UpdateTodo_result) (\(_,_val43) -> (case _val43 of {T.TStruct _val44 -> (to_Todo (T.TStruct _val44)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_DeleteTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v47 -> P.Just (1, ("todo",T.TI32 _v47))) $ deleteTodo_args_todo record
  ]
...
to_DeleteTodo_args (T.TStruct fields) = DeleteTodo_args{
  deleteTodo_args_todo = P.maybe (deleteTodo_args_todo default_DeleteTodo_args) (\(_,_val49) -> (case _val49 of {T.TI32 _val50 -> _val50; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
