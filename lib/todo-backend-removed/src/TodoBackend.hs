...
from_CreateTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v10 -> P.Just (1, ("title",T.TString $ E.encodeUtf8 _v10))) $ createTodo_args_title record
  ]
...
to_CreateTodo_args (T.TStruct fields) = CreateTodo_args{
  createTodo_args_title = P.maybe (createTodo_args_title default_CreateTodo_args) (\(_,_val12) -> (case _val12 of {T.TString _val13 -> E.decodeUtf8 _val13; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CreateTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v16 -> P.Just (0, ("success",from_Todo _v16))) $ createTodo_result_success record
  ]
...
to_CreateTodo_result (T.TStruct fields) = CreateTodo_result{
  createTodo_result_success = P.maybe (createTodo_result_success default_CreateTodo_result) (\(_,_val18) -> (case _val18 of {T.TStruct _val19 -> (to_Todo (T.TStruct _val19)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_GetTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v22 -> P.Just (1, ("id",T.TI32 _v22))) $ getTodo_args_id record
  ]
...
to_GetTodo_args (T.TStruct fields) = GetTodo_args{
  getTodo_args_id = P.maybe (getTodo_args_id default_GetTodo_args) (\(_,_val24) -> (case _val24 of {T.TI32 _val25 -> _val25; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v28 -> P.Just (0, ("success",from_Todo _v28))) $ getTodo_result_success record
  ]
...
to_GetTodo_result (T.TStruct fields) = GetTodo_result{
  getTodo_result_success = P.maybe (getTodo_result_success default_GetTodo_result) (\(_,_val30) -> (case _val30 of {T.TStruct _val31 -> (to_Todo (T.TStruct _val31)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_UpdateTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v34 -> P.Just (1, ("todo",from_Todo _v34))) $ updateTodo_args_todo record
  ]
...
to_UpdateTodo_args (T.TStruct fields) = UpdateTodo_args{
  updateTodo_args_todo = P.maybe (updateTodo_args_todo default_UpdateTodo_args) (\(_,_val36) -> (case _val36 of {T.TStruct _val37 -> (to_Todo (T.TStruct _val37)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UpdateTodo_result record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v40 -> P.Just (0, ("success",from_Todo _v40))) $ updateTodo_result_success record
  ]
...
to_UpdateTodo_result (T.TStruct fields) = UpdateTodo_result{
  updateTodo_result_success = P.maybe (updateTodo_result_success default_UpdateTodo_result) (\(_,_val42) -> (case _val42 of {T.TStruct _val43 -> (to_Todo (T.TStruct _val43)); _ -> P.error "wrong type"})) (Map.lookup (0) fields)
  }
...
from_DeleteTodo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v46 -> P.Just (1, ("todo",T.TI32 _v46))) $ deleteTodo_args_todo record
  ]
...
to_DeleteTodo_args (T.TStruct fields) = DeleteTodo_args{
  deleteTodo_args_todo = P.maybe (deleteTodo_args_todo default_DeleteTodo_args) (\(_,_val48) -> (case _val48 of {T.TI32 _val49 -> _val49; _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
