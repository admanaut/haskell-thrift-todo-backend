...
module Examples.Versioning.RemovedFieldNewClientOldServer.Client where

import qualified "todo-backend-removed" TodoBackend_Client as Client
import qualified "todo-backend-removed" Todobackendremoved_Types  as Types
...
connectAndRunExample = do
  cprint "Connecting New Client to Old Server on localhost:9090 ..."
